                    ...
                    @if(!count($dataBase) == 0)
                        <div class="panel-heading">  </div>
                            <table align="center"  style="width: 70%;" class="table">
                                <thead>
                                <tr><th><h4>Numer studenta/pracownika</h4></th>
                                    <th><h4>Rola</h4></th>>
                                    <th><h4>Imię</h4></th>
                                ...
                                <tr>
                                        ...
                                        <th>
                                            <form class="form-horizontal"  method="POST"
                                                  ...
                                                  action="/acceptEditChange/{{($data->user_id)}}">
                                                {{ csrf_field() }}
                                                <button type="submit"
                                        ...
                                        <th>
                                            <form class="form-horizontal"  method="post"
                                                  name="dismissEditChange"
                                                  action="/dismissEditChange/{{$data->user_id}}">
                                                {{ csrf_field() }}
                                                <button type="submit"
                                                        class="btn btn-primary">Odrzuć</button>
                                            </form>
                                        </th>
                                </tr>
                                @endforeach
