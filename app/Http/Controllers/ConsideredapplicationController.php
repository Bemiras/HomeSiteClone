        ...
        if(!Auth::check())
            ...
            $users = DB::table('users')
                ...
                ->select('users.*',
                    ...
                    'cards.promoter AS promoter',
                    'cards.userPromoter AS userPromoter',
                    'cards.deanery AS deanery',
                    'cards.liblary AS liblary',
                    'cards.dormitory AS dormitory',
                    'cards.commission_id AS user_commission_id',
                    'commissions.workerSekretarz AS worker_commission_id',
                    'commissions.id AS commission_id',
                    'users.id_card AS id_card')
                ->get();
